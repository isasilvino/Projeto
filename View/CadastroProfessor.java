...
public class CadastroProfessor extends javax.swing.JFrame {
    ...
    public CadastroProfessor() {
        ...
        txtDominio.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override
            public void focusGained(java.awt.event.FocusEvent evt) {
                if (txtDominio.getText().trim().equals("usuario@dominio")) {
                    txtDominio.setText(""); // limpa o espaço
                }
            }

            @Override
            public void focusLost(java.awt.event.FocusEvent evt) {
                if (txtDominio.getText().trim().isEmpty()) {
                    txtDominio.setText("usuario@dominio"); // restaura o espaço
                }
            }
        });
    }
